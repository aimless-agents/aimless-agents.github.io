...
This environment is default-set to return a sparse reward: it will give a reward $$r_t$$ of 0 at timestep $$t$$ if the block is within $$\epsilon$$ of goal state $$g$$ after taking action $$a$$ from state $$s$$, and -1 reward if it is not:
...
If you have any questions, comments, or doubts, feel free to reach out to us via email, or comment below! This is a learning experience for us and we would love to receive any kind of constructive or positive feedback.



## Resources

A huge, HUGE shoutout to Alex LaGrassa, Shreyas Chaudhari, and Sam Powers, who helped guide us at different parts throughout this journey. 
