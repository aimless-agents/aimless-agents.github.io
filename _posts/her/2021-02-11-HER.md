...
{% include image.html url="/img/her/sotagrandma.png" description="It can be difficult to keep up sometimes..." size=30 %}
...
The following is the full set of custom Reacher experiments we performed:
