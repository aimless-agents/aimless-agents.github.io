...
In the <a href="#demo">Demo section</a> at the bottom of this post, you’re faced with this same weather classification problem and play around with the predicted and true distributions to see how the values of entropy and cross entropy are affected. 
